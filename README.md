...
An elaborate example (topic modelling) is shown in topic\_modelling\_example/topic\_modelling.md, but you can do a lot of interesting basic exploratory analysis with this kind of data, for example examine reporting on political parties:
