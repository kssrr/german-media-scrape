...
# Uncomment this part if you want to save all articles locally:
#
# Directory for downloading:
#if (dir.exists("welt_articles")) {
#  warning("Directory exists, overwriting...")
#  unlink("welt_articles/", recursive = T)
#}
#dir.create("welt_articles/")
#
# Simple download:
#pb <- progress::progress_bar$new(
#  format = "  Downloading [:bar] :percent Elapsed: :elapsed Left: :eta",
#  total = length(article_urls),
#  
#)
#walk(
#  article_urls,
#  function(url) {
#    pb$tick()
#    name <- str_remove(url, "https://www.welt.de/") |> 
#      str_replace_all("/", "_")
#    destpath <- paste0("welt_articles/", name)
#    download.file(
#      url,
#      destfile = destpath,
#      method = "curl",
...
# Full scrape:
# Multi-threaded to speed up the processing of the articles.
